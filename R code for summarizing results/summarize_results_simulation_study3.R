# Summarize simulation results for adIVW, individual level data simulation
...
res.ivw.cp1 <- mean(res.tmp1[,1] + qnorm(0.025) * res.tmp1[,2] < beta0[1] & beta0[1] < res.tmp1[,1] + qnorm(0.975) * res.tmp1[,2])

# MR-Egger
res.egger1 <- mean(res.tmp1[,3])
res.egger.sd1 <- sd(res.tmp1[,3])
res.egger.se1 <- mean(res.tmp1[,4])
res.egger.cp1 <- mean(res.tmp1[,3] + qnorm(0.025) * res.tmp1[,4] < beta0[1] & beta0[1] < res.tmp1[,3] + qnorm(0.975) * res.tmp1[,4])

# MR-Median
res.median1 <- mean(res.tmp1[,5])
res.median.sd1 <- sd(res.tmp1[,5])
res.median.se1 <- mean(res.tmp1[,6])
res.median.cp1 <- mean(res.tmp1[,5] + qnorm(0.025) * res.tmp1[,5] < beta0[1] & beta0[1] < res.tmp1[,5] + qnorm(0.975) * res.tmp1[,6])

# Grapple
res.grapple1 <- mean(res.tmp1[,7])
res.grapple.sd1 <- sd(res.tmp1[,7])
res.grapple.se1 <- mean(res.tmp1[,8])
res.grapple.cp1 <- mean(res.tmp1[,7] + qnorm(0.025) * res.tmp1[,8] < beta0[1] & beta0[1] < res.tmp1[,7] + qnorm(0.975) * res.tmp1[,8])

# MRBEE
res.mrbee1 <- mean(res.tmp1[,9])
res.mrbee.sd1 <- sd(res.tmp1[,9])
res.mrbee.se1 <- mean(res.tmp1[,10])
res.mrbee.cp1 <- mean(res.tmp1[,9] + qnorm(0.025) * res.tmp1[,10] < beta0[1] & beta0[1] < res.tmp1[,9] + qnorm(0.975) * res.tmp1[,10])

# dIVW
res.divw1 <- mean(res.tmp1[,11])
res.divw.sd1 <- sd(res.tmp1[,11])
res.divw.se1 <- mean(res.tmp1[,12])
res.divw.cp1 <- mean(res.tmp1[,11] + qnorm(0.025) * res.tmp1[,12] < beta0[1] & beta0[1] < res.tmp1[,11] + qnorm(0.975) * res.tmp1[,12])

# adIVW
res.adivw1 <- mean(res.tmp1[,13])
res.adivw.sd1 <- sd(res.tmp1[,13])
res.adivw.se1 <- mean(res.tmp1[,14])
res.adivw.cp1 <- mean(res.tmp1[,13] + qnorm(0.025) * res.tmp1[,14] < beta0[1] & beta0[1] < res.tmp1[,13] + qnorm(0.975) * res.tmp1[,14])
...
res.ivw.cp2 <- mean(res.tmp2[,1] + qnorm(0.025) * res.tmp2[,2] < beta0[2] & beta0[2] < res.tmp2[,1] + qnorm(0.975) * res.tmp2[,2])

# MR-Egger
res.egger2 <- mean(res.tmp2[,3])
res.egger.sd2 <- sd(res.tmp2[,3])
res.egger.se2 <- mean(res.tmp2[,4])
res.egger.cp2 <- mean(res.tmp2[,3] + qnorm(0.025) * res.tmp2[,4] < beta0[2] & beta0[2] < res.tmp2[,3] + qnorm(0.975) * res.tmp2[,4])
...
res.grapple.cp2 <- mean(res.tmp2[,7] + qnorm(0.025) * res.tmp2[,8] < beta0[2] & beta0[2] < res.tmp2[,7] + qnorm(0.975) * res.tmp2[,8])

# MRBEE
res.mrbee2 <- mean(res.tmp2[,9])
res.mrbee.sd2 <- sd(res.tmp2[,9])
res.mrbee.se2 <- mean(res.tmp2[,10])
res.mrbee.cp2 <- mean(res.tmp2[,9] + qnorm(0.025) * res.tmp2[,10] < beta0[2] & beta0[2] < res.tmp2[,9] + qnorm(0.975) * res.tmp2[,10])

# dIVW
res.divw2 <- mean(res.tmp2[,11])
res.divw.sd2 <- sd(res.tmp2[,11])
res.divw.se2 <- mean(res.tmp2[,12])
res.divw.cp2 <- mean(res.tmp2[,11] + qnorm(0.025) * res.tmp2[,12] < beta0[2] & beta0[2] < res.tmp2[,11] + qnorm(0.975) * res.tmp2[,12])

# adIVW
res.adivw2 <- mean(res.tmp2[,13])
res.adivw.sd2 <- sd(res.tmp2[,13])
res.adivw.se2 <- mean(res.tmp2[,14])
res.adivw.cp2 <- mean(res.tmp2[,13] + qnorm(0.025) * res.tmp2[,14] < beta0[2] & beta0[2] < res.tmp2[,13] + qnorm(0.975) * res.tmp2[,14])
...
res.ivw.cp3 <- mean(res.tmp3[,1] + qnorm(0.025) * res.tmp3[,2] < beta0[3] & beta0[3] < res.tmp3[,1] + qnorm(0.975) * res.tmp3[,2])

# MR-Egger
res.egger3 <- mean(res.tmp3[,3])
res.egger.sd3 <- sd(res.tmp3[,3])
res.egger.se3 <- mean(res.tmp3[,4])
res.egger.cp3 <- mean(res.tmp3[,3] + qnorm(0.025) * res.tmp3[,4] < beta0[3] & beta0[3] < res.tmp3[,3] + qnorm(0.975) * res.tmp3[,4])

# MR-Median
res.median3 <- mean(res.tmp3[,5])
res.median.sd3 <- sd(res.tmp3[,5])
res.median.se3 <- mean(res.tmp3[,6])
res.median.cp3 <- mean(res.tmp3[,5] + qnorm(0.025) * res.tmp3[,5] < beta0[3] & beta0[3] < res.tmp3[,5] + qnorm(0.975) * res.tmp3[,6])

# Grapple
res.grapple3 <- mean(res.tmp3[,7])
res.grapple.sd3 <- sd(res.tmp3[,7])
res.grapple.se3 <- mean(res.tmp3[,8])
res.grapple.cp3 <- mean(res.tmp3[,7] + qnorm(0.025) * res.tmp3[,8] < beta0[3] & beta0[3] < res.tmp3[,7] + qnorm(0.975) * res.tmp3[,8])

# MRBEE
res.mrbee3 <- mean(res.tmp3[,9])
res.mrbee.sd3 <- sd(res.tmp3[,9])
res.mrbee.se3 <- mean(res.tmp3[,10])
res.mrbee.cp3 <- mean(res.tmp3[,9] + qnorm(0.025) * res.tmp3[,10] < beta0[3] & beta0[3] < res.tmp3[,9] + qnorm(0.975) * res.tmp3[,10])

# dIVW
res.divw3 <- mean(res.tmp3[,11])
res.divw.sd3 <- sd(res.tmp3[,11])
res.divw.se3 <- mean(res.tmp3[,12])
res.divw.cp3 <- mean(res.tmp3[,11] + qnorm(0.025) * res.tmp3[,12] < beta0[3] & beta0[3] < res.tmp3[,11] + qnorm(0.975) * res.tmp3[,12])

# adIVW
res.adivw3 <- mean(res.tmp3[,13])
res.adivw.sd3 <- sd(res.tmp3[,13])
res.adivw.se3 <- mean(res.tmp3[,14])
res.adivw.cp3 <- mean(res.tmp3[,13] + qnorm(0.025) * res.tmp3[,14] < beta0[3] & beta0[3] < res.tmp3[,13] + qnorm(0.975) * res.tmp3[,14])
...
write.csv(res.summary, "tables/res.summary.main.table3.csv",row.names = FALSE)
