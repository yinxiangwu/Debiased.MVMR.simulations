# Summarize simulation results for adIVW, three exposures example with balanced horizontal pleiotropy
...
tbl_to_present <- list("supp_tables8" = c(1,3,5), # the row numbers corresponding to main table
                       "supp_tables9" = c(7,9,11),
                       "supp_tables10" = c(2,4,6),
                       "supp_tables11" = c(8,10,12))

tbl_num <- "supp_tables8" # to summarize the results for the other tables, change this 
